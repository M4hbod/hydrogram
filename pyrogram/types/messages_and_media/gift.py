...
class Gift(Object):
    ...
    async def _parse(
        ...
        # A mutable default argument is shared between every call; normalise
        # here instead so each invocation starts from its own empty mapping.
        users = users or {}
        chats = chats or {}
    ...
    async def show(self) -> bool:
        ...
        .. code-block:: python
            ...
            await client.show_gift(owned_gift_id="message_id")
    ...
    async def hide(self) -> bool:
        ...
        .. code-block:: python
            ...
            await client.hide_gift(owned_gift_id="message_id")
    ...
    async def convert(self) -> bool:
        ...
        .. code-block:: python
            ...
            await client.convert_gift_to_stars(owned_gift_id="message_id")
    ...
    async def upgrade(
        ...
        .. code-block:: python
            ...
            await client.upgrade_gift(owned_gift_id="message_id")
    ...
    async def buy(
        ...
        .. code-block:: python
            ...
            await app.send_resold_gift(
                gift_link="https://t.me/nft/NekoHelmet-9215", new_owner_chat_id="me"
            )
    ...
    async def send(
        ...
        .. code-block:: python
            ...
            await client.send_gift(chat_id="me", gift_id=gift.id)
