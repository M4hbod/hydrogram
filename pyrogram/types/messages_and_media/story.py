...
class Story(Object, Update):
    ...
    async def reply_text(
        ...
        .. code-block:: python
            ...
            await client.send_message(
                ...
                text="hello",
                reply_parameters=types.ReplyParameters(chat_id=chat_id, story_id=story.id),
            )
    ...
    async def copy(
        ...
        .. code-block:: python
            ...
            await client.copy_story(
                chat_id=story.chat.id, from_chat_id=from_chat_id, story_id=story.id
            )
    ...
    async def react(self, emoji: int | str | None = None) -> bool:
        ...
        .. code-block:: python
            ...
            await client.send_reaction(chat_id=story.chat.id, story_id=story.id, emoji="🔥")
    ...
    async def forward(
        ...
        .. code-block:: python
            ...
            await client.forward_story(
                chat_id=chat_id, from_chat_id=story.chat.id, story_id=story.id
            )
