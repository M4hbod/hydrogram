...
class Folder(Object):
    ...
    async def edit(
        ...
        .. code-block:: python
            ...
            await client.edit_folder(folder_id, name="New folder", included_chats=["me"])
    ...
    async def include_chat(self, chat_id: int | str) -> bool:
        ...
        .. code-block:: python
            ...
            await client.edit_folder(folder_id=folder_id, included_chats=[chat_id])
    ...
    async def pin_chat(self, chat_id: int | str):
        ...
        .. code-block:: python
            ...
            await client.edit_folder(
                folder_id=folder_id, included_chats=[chat_id], pinned_chats=[chat_id]
            )
