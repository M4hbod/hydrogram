        ...
        Example:
            .. code-block:: python
                ...
                await app.edit_ephemeral_message_media(
                    chat_id, receiver_user_id, message_id, InputMediaPhoto("new_photo.jpg")
                )

                # Replace the current media with a local video
                await app.edit_ephemeral_message_media(
                    chat_id, receiver_user_id, message_id, InputMediaVideo("new_video.mp4")
                )

                # Replace the current media with a local audio
                await app.edit_ephemeral_message_media(
                    chat_id, receiver_user_id, message_id, InputMediaAudio("new_audio.mp3")
                )
        """
