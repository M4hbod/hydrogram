    ...
    async def send_story(
        ...
        try:
                        ...
                        media = raw.types.InputMediaUploadedDocument(
                            ...
                            attributes=[
                                ...
                                raw.types.DocumentAttributeFilename(
                                    file_name=file_name or pathlib.Path(media).name
                                ),
                            ],
                        )
                    else:
            ...
            if privacy == enums.StoriesPrivacyRules.PUBLIC:
                ...
                if allowed_users_:
                    privacy_rules.append(
                        raw.types.InputPrivacyValueAllowUsers(users=allowed_users_)
                    )
                if allowed_chats:
                    privacy_rules.append(
                        raw.types.InputPrivacyValueAllowChatParticipants(chats=allowed_chats)
                    )
            else:
                privacy_rules.append(raw.types.InputPrivacyValueAllowAll())
