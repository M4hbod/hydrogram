    ...
    async def reorder_collection_gifts(
        ...
        Example:
            .. code-block:: python
                ...
                await app.reorder_collection_gifts(
                    "me",
                    123,
                    ["https://t.me/nft/NekoHelmet-9215", "https://t.me/nft/JellyBunny-729"],
                )
        """

        stargifts = [await utils.get_input_stargift(self, gift) for gift in gift_ids]
