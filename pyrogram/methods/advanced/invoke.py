    ...
    async def invoke(
        ...
        Parameters:
            ...
            business_connection_id (``str``, *optional*):
                Send the request on behalf of this business connection.
        ...
        if business_connection_id:
            ...
            # The connection belongs to the granting account's DC, which need
            # not be ours -- sending it on the wrong session is rejected.
            session = await self.business_connection_session(business_connection_id)
