...
def ikb(rows: list[list[str | tuple[str, str]]] | None = None) -> InlineKeyboardMarkup:
    ...
    Returns:
        :obj:`~pyrogram.types.InlineKeyboardMarkup`: An InlineKeyboardMarkup object.
    """
    if rows is None:
        rows = []
...
def btn(text: str, value: str, type="callback_data") -> InlineKeyboardButton:
    ...
    Returns:
        :obj:`~pyrogram.types.InlineKeyboardButton`: An InlineKeyboardButton object.
    """
...
def bki(keyboard: InlineKeyboardButton) -> list[list[str | tuple[str, str]]]:
    ...
    Parameters:
        keyboard (:obj:`~pyrogram.types.InlineKeyboardMarkup`):
...
def ntb(button: InlineKeyboardButton) -> list:
    ...
    Parameters:
        button (:obj:`~pyrogram.types.InlineKeyboardButton`):
...
def kb(rows=None, **kwargs) -> ReplyKeyboardMarkup:
    ...
    Returns:
        :obj:`~pyrogram.types.ReplyKeyboardMarkup`: A ReplyKeyboardMarkup object.
    """
    if rows is None:
        rows = []
...
def force_reply(selective=True) -> ForceReply:
    ...
    Returns:
        :obj:`~pyrogram.types.ForceReply`: A ForceReply object.
    """
